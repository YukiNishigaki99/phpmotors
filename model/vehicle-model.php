...
// Insert a new classification to the classifications table
function addClassification($classificationName){
    ...
    $stmt = $db->prepare($sql);
    // The next line replace the placeholders in the SQL statement
    // with the actual values in the variables 
    // and tells the database the typeof data it is.
